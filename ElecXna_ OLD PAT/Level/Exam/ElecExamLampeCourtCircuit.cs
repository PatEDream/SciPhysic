...
namespace QM.Level
{
    public class ElecExamLampeCourtCircuit : TestQuestion
    {
       ...
       // protected ETileBoard m_TileBoard2 = new ETileBoard();
        ...
        public override void StartLevel(String Param1)
        {
            ...
            m_Name = "ElecExam_LampeCourtCircuit";
            ...
            WButton BDerivation = new WButton(TheTextPos[Which], "ElecExam_NonCarEnCourtCircuit", FontManager.eFontID.Font2, AnswerYes);
            AddObj(BDerivation);
            //BDerivation.m_PntSize.m_Pos.X = sx / 2 - 100 - SizeBoard/2 - BDerivation.m_PntSize.m_Size.X/2;

            WButton BSerie = new WButton(TheTextPos[1-Which], "ElecExam_OuiUnePartieDucourantPasseDansLaLampe", FontManager.eFontID.Font2, AnswerNo);
            AddObj(BSerie);
        ...
        void CreateCircuitLampeCourtCircuit(ETileBoard _TileBoard)
        {
            ...
            _TileBoard.m_TileScene.AddTile(ETile.eType.Resistance,  new Point(2, 0), Angle360.Est);
            ...
            _TileBoard.m_TileScene.AddTile(ETile.eType.Wire, new Point(2, 2), Angle360.South);
