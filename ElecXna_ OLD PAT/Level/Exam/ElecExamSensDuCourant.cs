...
namespace QM.Level
{
    public class ElecExamSensDuCourant : TestQuestion
    {
        ...
        public override void StartLevel(String Param1)
        {
            ...
            AddObj(m_TileBoard1);
            CreateCircuitSensDuCourant(m_TileBoard1);
            ...
            WButton BDerivation =  new WButton(TheTextPos[Which], "ElecExam_LeCourantVaDuPolePositif", FontManager.eFontID.Font2, AnswerYes);
            AddObj(BDerivation);
            //BDerivation.m_PntSize.m_Pos.X = sx / 2 - 100 - SizeBoard/2 - BDerivation.m_PntSize.m_Size.X/2;

            WButton BSerie = new WButton(TheTextPos[1 - Which], "ElecExam_LeCourantVaDuPoleNegatif", FontManager.eFontID.Font2, AnswerNo);
            AddObj(BSerie);
            //BSerie.m_PntSize.m_Pos.X = sx / 2 + 100 + SizeBoard/2 - BSerie.m_PntSize.m_Size.X/2;
        }


        void CreateCircuitSensDuCourant(ETileBoard _TileBoard)
        {
            ...
            _TileBoard.m_TileScene.AddTile(ETile.eType.Pile, new Point(0, 1), Angle360.South);
            _TileBoard.m_TileScene.AddTile(ETile.eType.Resistance, new Point(2, 1), Angle360.South);

            _TileBoard.m_TileScene.AddTile(ETile.eType.Wire2, new Point(0, 2), Angle360.North);
            _TileBoard.m_TileScene.AddTile(ETile.eType.Wire, new Point(1, 2), Angle360.Est);
            _TileBoard.m_TileScene.AddTile(ETile.eType.Wire2, new Point(2, 2), Angle360.West);
